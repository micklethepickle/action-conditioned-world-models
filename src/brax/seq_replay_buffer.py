...
"""
Copy of the efficient sequential replay buffer implemented by Tianwei: https://github.com/twni2016/pomdp-baselines/blob/main/buffers/seq_replay_buffer_efficient.py
"""
...
class SeqReplayBuffer:
    ...
    def __init__(
        ...
        action_dim,
        sampled_seq_len: int,
        # sample_weight_baseline: float, # Removed this feature
        observation_type,
        **kwargs
    ):
        """
    ...
    def _compute_valid_starts(self, seq_len):
        ...
        total_weights = num_valid_starts
    ...
    def random_episodes(self, batch_size, start_index=0):
        """
        ...
        for k in batch.keys():
            batch[k] = (
                batch[k]
                .reshape(batch_size, self._sampled_seq_len, -1)[:, start_index:]
            )
