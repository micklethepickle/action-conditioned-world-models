...
def main(argv):
    ...
    log_path = os.path.join('./logs/myriad-icml-noise', run_name)
    ...
    if config_env.constant_dt:
        ...
        env = MyriadEnv(base_env, config_env.length, default_dt, config_env.distractor_dims, config_env.noise)
        eval_env = MyriadEnv(base_env, config_env.length, default_dt, config_env.distractor_dims, config_env.noise)

    else:
        default_time = base_env.T
        dt = default_time/config_env.length
        env = MyriadEnv(base_env, config_env.length, dt, config_env.distractor_dims, config_env.noise)
        eval_env = MyriadEnv(base_env, config_env.length, dt, config_env.distractor_dims, config_env.noise)
